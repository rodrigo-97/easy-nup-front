...
export function CreateContractualization() {
  ...
  return (
    <Row className="gx-2 custom-form">
      ...
      <div className="p-4 app-bg col-12 col-md-8">
        <Row>
          {
            formStep === 1 && (
              <>
          ...
          {/* {
            formStep === 4 && (
              <>
                <small>Definir tipos de serviços</small>
                {serviceTypes.map((e, i) => {
                  return (
                    <div className={`mt-4 col-12 col-md-8 `} key={i}>
                      <Row key={i}>
                        ...
                        {e.params.map((_p, paramIndex) => {
                          return (
                            <div key={paramIndex} className="col-6">
                              ...
                              <div className="d-flex gap-4 align-items-center">
                                ...
                                <div>
                                  <Button color="transparent mb-2" onClick={() => removeParamFromServiceType(i, paramIndex)}>
                                    <FaMinus size={20} />
                                  </Button>
                                </div>
                              </div>
                ...
                return (
                  <div className="d-flex flex-wrap gap-4 mb-5">
                    <div className="service-type">
                      <div className="d-flex justify-content-between">
                        <small>Tipo de serviço {i + 1}</small>
                        <small className="pointer text-red" onClick={() => removeServiceType(i)}>remover</small>
                      </div>
                      ...
                      <div className="text-start">
                        {
                          e.params.map((j, k) => {
                            return (
                              <div className="mb-3">
                                <div className="d-flex justify-content-between">
                                  <small>Parâmetro {k + 1}</small>
                                  <small className="pointer text-red" onClick={() => removeParamFromServiceType(i, k)}>remover</small>
                                </div>
                                <div className="d-flex gap-3  app-bg p-4" >
                                  <div className="">
                                    <p>Nome</p>
                                    <input type="text" className="form-control" placeholder="Nome" />
                                  </div>
                                  ...
                                  <div className="">
                                    <p>Fi</p>
                                    <input type="text" className="form-control" placeholder="Fi" />
                                  </div>
                                </div>
                              </div>
                            )
